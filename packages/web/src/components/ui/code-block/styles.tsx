...
export const codeBlockHeaderStyles =
  "flex min-h-10 sticky top-0 z-10 h-10 max-h-10 grow items-center justify-between border-b border-gray-6 bg-muted/20 backdrop-blur-sm hover:bg-muted/40 pl-4 pr-2 rounded-top-xl";
...
export const collapseButtonStyles = "flex items-center justify-center cursor-pointer size-7";
